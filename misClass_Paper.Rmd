...
simex.plot <- ggplot(plotPoints, aes(x = lambda + 1, y = Bootstrap)) +
  geom_point(col = "grey") +
  geom_point(data = plotEst, aes(x = lambda + 1, y = X22), size = 3) +
  ...
  geom_text(x = plotEst$lambda[1]+1.4, y = plotEst$X22[1], label = "MCSIMEX estimate") +
  geom_text(x = plotEst$lambda[2]+1.4, y = plotEst$X22[2], label = "Naïve estimate") +
  theme_bw() +
...
```{r, echo = FALSE}
ggsave(simex.plot, file = "Output/Figures/simex.plot.pdf",
